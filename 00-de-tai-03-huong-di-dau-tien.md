...
Member phải đồng ý chính sách và được Administrator duyệt đơn xin quyền đăng trước khi có thể tạo/công khai công thức. Sau khi được cấp quyền, tác giả tạo/xem/sửa/xóa bài của mình như một lớp mạng xã hội thu nhỏ và tự công khai bài hợp lệ; Administrator không duyệt từng bài mà xử lý nội dung khi có báo cáo. AI là công cụ hỗ trợ, không tự áp dụng chế tài. Nhóm chưa thêm actor `Expert` ở phiên bản đầu.
...
3. Danh mục và các bài công thức chay đang công khai do Administrator hoặc Member đã được cấp quyền đăng tạo.
...
10. Member đồng ý chính sách, gửi đơn xin quyền đăng và chỉ được quản lý bài sau khi Admin cấp quyền; tác giả tạo/xem/sửa/xóa bài của mình mà không qua hàng đợi duyệt riêng. Member đã đăng nhập được Like/Unlike, tối đa một Like trên mỗi bài; bình luận và reply phải hỗ trợ lồng nhiều cấp. MVP không có đánh giá 1–5 sao. Người dùng có thể báo cáo bài và Admin hậu kiểm/xử lý.
11. Chỉ Member đã đăng nhập được tìm nhà hàng chay quanh địa chỉ tự nhập với ngưỡng khoảng cách đường bộ 500 m, 1 km, 5 km hoặc 10 km; ứng dụng không dùng GPS, không liên kết đề xuất với món đã tìm và không quản lý dữ liệu nhà hàng do Google Maps cung cấp.
...
1. Administrator tạo bài mẫu hoặc duyệt đơn xin quyền đăng; Member được cấp quyền tạo/công khai bài công thức và gán danh mục/nhãn phù hợp.
...
[SRS mục 3.20](docs/requirements/SRS.md) là bản tổng hợp quyết định ngày 12/09/2026: web responsive tiếng Việt; Guest/Member/Admin; bốn loại ăn chay; email/password và Google Login; Like/báo cáo bài và bình luận, reply nhiều cấp; thông báo trong app và email. Free/Plus/Pro cùng chức năng AI với 5/15/50 lượt/ngày, thanh toán thật. AI chọn công thức sẵn có, không tạo công thức mới; menu tuần do Member xác nhận.

Nhà hàng hiển thị danh sách + bản đồ theo khoảng cách đường bộ, mặc định 10 lượt/Member/ngày; không quản lý nhà hàng hoặc gợi ý theo món đã tìm. Theo Q35, đây là phạm vi nhóm tự chọn từ đề tài mang tính đề xuất, không có điều kiện chờ giảng viên xác nhận.
